...
% if target["name"] in ["cw310", "cw305"]:
  ...
  assign clk_io_div4_trigger_hw_en = dio_out[DioOutGpioGpio9];
  assign clk_io_div4_trigger_hw_oe = dio_oe[DioOutGpioGpio9];
  assign clk_io_div4_trigger_sw_en = dio_out[DioOutGpioGpio8];
  assign clk_io_div4_trigger_sw_oe = dio_oe[DioOutGpioGpio8];
  % else:
  logic clk_io_div4_trigger_hw_en, manual_in_io_clk_trigger_hw_en;
  logic clk_io_div4_trigger_hw_oe, manual_in_io_clk_trigger_hw_oe;
  logic clk_io_div4_trigger_sw_en, manual_in_io_clk_trigger_sw_en;
