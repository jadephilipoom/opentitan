 ...
 * +---------+------------------+----------+
 * | 32 bits | chain address    | 192..223 |
 * +---------+------------------+----------+
 * | 32 bits | hash address     | 224..255 |
 * +---------+------------------+----------+
 *
 ...
 */
void spx_addr_layer_set(uint32_t addr[8], uint32_t layer);
 ...
 */
void spx_addr_tree_set(uint32_t addr[8], uint64_t tree);
 ...
 */
void spx_addr_type_set(uint32_t addr[8], spx_addr_type_t type);
 ...
 */
void spx_addr_subtree_copy(uint32_t out[8], const uint32_t in[8]);
 ...
 */
void spx_addr_chain_set(uint32_t addr[8], uint32_t chain);
 ...
 */
void spx_addr_hash_set(uint32_t addr[8], uint32_t hash);

/**
 * Copies the layer, treee, and keypair parts of a WOTS or FORS address.
 *
 ...
 */
void spx_addr_tree_height_set(uint32_t addr[8], uint32_t tree_height);
 ...
 */
void spx_addr_tree_index_set(uint32_t addr[8], uint32_t tree_index);
