...
#ifndef OPENTITAN_SW_DEVICE_SILICON_CREATOR_LIB_SIGVERIFY_SPHINCSPLUS_UTILS2_H_
#define OPENTITAN_SW_DEVICE_SILICON_CREATOR_LIB_SIGVERIFY_SPHINCSPLUS_UTILS2_H_
 ...
 */
uint64_t spx_utils_bytes_to_u64(const unsigned char *in, size_t inlen);
...
rom_error_t spx_utils_compute_root(const unsigned char *leaf, uint32_t leaf_idx,
                                   uint32_t idx_offset,
                                   const unsigned char *auth_path,
                                   uint32_t tree_height, const spx_ctx *ctx,
                                   uint32_t addr[8], uint32_t *root);

#endif  // OPENTITAN_SW_DEVICE_SILICON_CREATOR_LIB_SIGVERIFY_SPHINCSPLUS_UTILS2_H_
