...
| Name                 | Offset   |
|:---------------------|:---------|
| MP_BANK_CFG_SHADOWED | 0x16c    |


### Fields

```wavejson
{"reg": [{"name": "ERASE_EN", "bits": 1, "attr": ["rw"], "rotate": -90}, {"bits": 31}], "config": {"lanes": 1, "fontsize": 10, "vspace": 100}}
```

|  Bits  |  Type  |  Reset  | Name     | Description            |
|:------:|:------:|:-------:|:---------|:-----------------------|
|  31:1  |        |         |          | Reserved               |
|   0    |   rw   |   0x0   | ERASE_EN | Bank wide erase enable |
