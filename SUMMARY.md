...
- [Hardware IP Blocks](./hw/ip/README.md)
  ...
  - [AES](./hw/ip/aes/README.md)
    ...
    - [Device Interface Functions](./sw/ip/aes/dif/dif_aes.h)
  ...
  - [GPIO](./hw/ip/gpio/README.md)
    ...
    - [Device Interface Functions](./sw/ip/gpio/dif/dif_gpio.h)
  ...
  - [Key Manager DPE](./hw/ip/keymgr_dpe/README.md)
    ...
    - [Interface and Registers](./hw/ip/keymgr_dpe/data/keymgr_dpe.hjson)
    - [Checklist](./hw/ip/keymgr_dpe/doc/checklist.md)
...
- [Device Software](./sw/device/README.md)
  - [Device Libraries](./sw/lib/sw/device/README.md)
    - [DIF Library](./sw/ip/base/dif/README.md)
      ...
      - [Always-On Timer Checklist](sw/ip/aon_timer/dif/dif_aon_timer.md)
      - [Clock Manager Checklist](sw/ip/clkmgr/dif/dif_clkmgr.md)
      - [CSRNG Checklist](sw/ip/csrng/dif/dif_csrng.md)
      - [EDN Checklist](sw/ip/edn/dif/dif_edn.md)
      - [Entropy Source Checklist](sw/ip/entropy_src/dif/dif_entropy_src.md)
      - [Flash Controller Checklist](sw/ip/flash_ctrl/dif/dif_flash_ctrl.md)
      - [GPIO Checklist](sw/ip/gpio/dif/dif_gpio.md)
      - [HMAC Checklist](sw/ip/hmac/dif/dif_hmac.md)
      - [I2C Checklist](sw/ip/i2c/dif/dif_i2c.md)
      - [Key Manager Checklist](sw/ip/keymgr/dif/dif_keymgr.md)
      - [KMAC Checklist](sw/ip/kmac/dif/dif_kmac.md)
      - [Lifecycle Checklist](sw/ip/lc_ctrl/dif/dif_lc_ctrl.md)
      - [OTBN Checklist](sw/ip/otbn/dif/dif_otbn.md)
      - [OTP Controller Checklist](sw/ip/otp_ctrl/dif/dif_otp_ctrl.md)
      - [Pattern Generator Checklist](sw/ip/pattgen/dif/dif_pattgen.md)
      - [Pin Multiplexer Checklist](sw/ip/pinmux/dif/dif_pinmux.md)
      - [PWM Checklist](sw/ip/pwm/dif/dif_pwm.md)
      - [Power Manager Checklist](sw/ip/pwrmgr/dif/dif_pwrmgr.md)
      - [ROM Checklist](sw/ip/rom_ctrl/dif/dif_rom_ctrl.md)
      - [Reset Manager Checklist](sw/ip/rstmgr/dif/dif_rstmgr.md)
      - [RV Core Ibex Checklist](sw/ip/rv_core_ibex/dif/dif_rv_core_ibex.md)
      - [PLIC Checklist](sw/ip/rv_plic/dif/dif_rv_plic.md)
      - [RV Timer Checklist](sw/ip/rv_timer/dif/dif_rv_timer.md)
      - [Sensor Controller Checklist](sw/ip/sensor_ctrl/dif/dif_sensor_ctrl.md)
      - [SPI Device Checklist](sw/ip/spi_device/dif/dif_spi_device.md)
      - [SPI Host Checklist](sw/ip/spi_host/dif/dif_spi_host.md)
      - [SRAM Controller Checklist](sw/ip/sram_ctrl/dif/dif_sram_ctrl.md)
      - [System Reset Controller Checklist](sw/ip/sysrst_ctrl/dif/dif_sysrst_ctrl.md)
      - [UART Checklist](sw/ip/uart/dif/dif_uart.md)
      - [USB Checklist](sw/ip/usbdev/dif/dif_usbdev.md)
    ...
    - [OpenTitan Standard Library](./sw/lib/sw/device/base/README.md)
        - [Freestanding C Headers](./sw/lib/sw/device/base/freestanding/README.md)
  - [Silicon Creator Software](./sw/lib/sw/device/silicon_creator/README.md)
    - [Manufacturing Firmware](./sw/lib/sw/device/silicon_creator/manuf/README.md)
      - [Test Plan](./sw/lib/sw/device/silicon_creator/manuf/data/manuf_testplan.hjson)
